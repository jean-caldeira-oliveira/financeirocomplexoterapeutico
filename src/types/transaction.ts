...
// IMP - Impostos
export type ImpostosCategory = "imp_impostos" | "imp_taxas";

// PROL - Pró-labore
export type ProlaboreCategory = "prol_socios" | "prol_folha";

// BC - Banco
export type BancoCategory = "bc_tarifas" | "bc_juros" | "bc_emprestimos";
...
export interface Patient {
  ...
  active: boolean;
  createdAt: string;
  originalInstallments?: number; // original installment count before any extensions
  extensionMonths: number; // total months added via extensions (default 0)
}
...
export const expenseCategoryGroups: Record<
