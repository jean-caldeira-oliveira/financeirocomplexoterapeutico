        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                ...
                {[
                  ...
                  >
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        setTypeFilters((prev) => toggleFilter(prev, opt.value))
                      }
                    />
                    {opt.label}
                  </label>
          ...
          <Badge variant="outline" className="gap-2 py-2">
            ...
            <span className="font-bold">
              {filteredInvoices.length} cobranças
            </span>
          </Badge>
        </div>
                  ...
                  {filteredInvoices.map((invoice) => {
                    ...
                    return (
                      <Fragment key={invoice.id}>
                        <TableRow
                          className={hasPayments ? "cursor-pointer" : ""}
                          onClick={() =>
                            hasPayments && toggleExpanded(invoice.id)
                          }
                        >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {invoice.billingMethod && (
                                <Badge variant="outline" className="text-xs">
                                  {billingMethodLabels[invoice.billingMethod] ||
                                    invoice.billingMethod}
                                </Badge>
                              )}
                            </div>
                                ...
                                (() => {
                                  ...
                                  if (
                                    ...
                                    const paymentDate = new Date(
                                      earlyPayments[0].paymentDate
                                    );
                                    return (
                                      <Badge
                                        variant="outline"
                                        className="gap-1 text-xs border-blue-300 text-blue-600 bg-blue-50 dark:bg-blue-950/30"
                                      >
                                        <CalendarClock className="h-3 w-3" />
                                        Antecipado (
                                        {format(paymentDate, "MMM/yy", {
                                          locale: ptBR,
                                        })}
                                        )
                                      </Badge>
                                  ...
                                  if (
                                    ...
                                    return (
                                      <Badge
                                        variant="outline"
                                        className="gap-1 text-xs border-amber-300 text-amber-600 bg-amber-50 dark:bg-amber-950/30"
                                      >
                                        <CalendarClock className="h-3 w-3" />
                                        Recebido em{" "}
                                        {format(paymentDate, "MMM/yy", {
                            ...
                            <div className="flex items-center justify-end gap-2">
                              {invoice.status !== "paid" &&
                                (() => {
                                  ...
                                  const message = `Olá! Gostaríamos de lembrar sobre a mensalidade de *${
                                    invoice.patientName
                                  }* no valor de *${formatCurrency(
                                    getInvoiceTotalDue(invoice)
                                  )}*, com vencimento em *${dueDateFormatted}*. Em caso de dúvidas, estamos à disposição.`;
                                  const whatsUrl = `https://wa.me/${phoneWithCountry}?text=${encodeURIComponent(
                                    message
                                  )}`;
                                  return (
                                    <Tooltip>
                              ...
                              {invoice.status === "paid" ? (
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    Limpar recebimentos e voltar para não pago
                                  </TooltipContent>
                                </Tooltip>
                              ) : (
                            ...
                            >
                              ...
                              <TableCell className="text-sm font-medium">
                                ...
                                {payment.isLate && (
                                  <Badge
                                    variant="outline"
                                    className="ml-2 text-xs border-red-300 text-red-500"
                                  >
                                    Em atraso
                                  </Badge>
                                )}
