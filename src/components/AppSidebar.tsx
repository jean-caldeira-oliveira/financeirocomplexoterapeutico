...
function buildNavItems(isAdmin: boolean): NavEntry[] {
  ...
  },
  {
    ...
    subItems: [
      ...
      { to: "/administrativo/sistema-familiares", label: "Sistema Familiares", icon: Users },
    ],
  },
  {
    to: "/juridico",
  ...
  },
  {
    ...
    badge: "Em construção",
    subItems: [
      { to: "/saude/clinico-geral", label: "Clínico Geral", icon: Stethoscope },
      { to: "/saude/psicologia", label: "Psicologia", icon: Brain },
      { to: "/saude/psiquiatria", label: "Psiquiatria", icon: Pill },
      { to: "/saude/enfermaria", label: "Enfermaria", icon: Syringe },
      { to: "/saude/historico-dos-pacientes", label: "Histórico dos pacientes", icon: FileClock },
    ],
  },
  {
    to: "/operacional",
    ...
    badge: "Em construção",
    subItems: [
      { to: "/operacional/assistencia-social", label: "Assistência Social", icon: HandHeart },
      { to: "/operacional/terapeutica", label: "Terapêutica", icon: Sparkles },
    ],
  },
  {
    to: "/fiscalizacoes",
    ...
    badge: "Em construção",
    subItems: [
      { to: "/fiscalizacoes/vigilancia-sanitaria", label: "Vigilância Sanitária", icon: ShieldCheck },
      { to: "/fiscalizacoes/ministerio-do-trabalho", label: "Ministério do Trabalho", icon: HardHat },
      { to: "/fiscalizacoes/conselhos", label: "Conselhos", icon: Landmark },
      { to: "/fiscalizacoes/ministerio-publico", label: "Ministério Público", icon: Scale },
    ],
  },
